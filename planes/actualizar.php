    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <img style="width:40px;height:40px;" src="../assets/images/logo-mini.png" alt="logo"> <!-- LOGO DE ATORY-->
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Atory Solution</h5>
          ...
          <li class="nav-item nav-category">
            <span class="nav-link">Barra de Navegacion</span>
          </li>
          ...
          <li class="nav-item menu-items active">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../pages/ui-features/buttons.html">Rurales</a></li>
                <li class="nav-item"> <a class="nav-link" href="../pages/ui-features/dropdowns.html">Urbanos</a></li>
                <li class="nav-item"> <a class="nav-link" href="../pages/ui-features/typography.html">Empresas</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject mb-1">Desloguearse</p>
                    </div>
                  </a>
        ...
        <div class="main-panel">
          <div class="content-wrapper"> <!-- ESTO ES LO QUE TENEMOS QUE MODIFICAR -->
            <div class="card-body">
                ...
                <input type="submit" class="btn btn-primary btn-block" value="Actualizar"formmethod="post"formaction=../planes/actplan.php>
            </form>
